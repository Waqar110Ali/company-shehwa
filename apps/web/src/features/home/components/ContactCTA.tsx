// features/home/components/ContactCTA.tsx
...
export default function ContactCTA() {
  const info = useSectionContent("contactInfo", contactInfo);
            ...
            <div>
              ...
              <FadeUp delay={0.15}>
                <h2 className="mt-8 text-5xl font-black leading-tight text-white lg:text-6xl">
                  Let's Build
                  <br />
                  <GradientText>Something Incredible</GradientText>
                </h2>
              </FadeUp>

              <FadeUp delay={0.3}>
                <p className="mt-8 max-w-xl text-lg leading-8 text-slate-300">
                  Whether you're launching a startup, building enterprise software,
                  or integrating Artificial Intelligence into your business, our
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <h4 className="mt-1 font-semibold text-white">{item.value}</h4>
                        </div>
                      </motion.div>
                    );
                  })}
