...
// //       <div className="p-4">
// //         <SearchChats value={search} onChange={setSearch} />
// //       </div>
...
//       {/* SearchChats already has its own p-4 — no extra wrapper here,
//           that was double-padding it before. */}
//       <SearchChats value={search} onChange={setSearch} />
...
// apps/web/src/features/assistant/components/ChatSidebar.tsx
import { useMemo, useState } from "react";
import { Plus } from "lucide-react";
